...
for i=1, #voice 	do message = message ..ii..' - *{* '..  voice[i]..' *} ⋙ *( 🗣️بصمه) \n' 	 ii = ii + 1 end
...
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username
text = [[ •🌟 ¦ أهلًا بك في قائمه الاوامر لسورس FZRD
...
sendMsg(msg.chat_id_,msg.id_,'ابشر يا الغالي مع السلامه  ') 
rem_data_group(msg.chat_id_)
...
elseif Text== "fzrd"  then return sendMsg(msg.chat_id_,msg.id_,"[مــًـبرمج الســًـورس 😍](t.me/vv4kv)")
