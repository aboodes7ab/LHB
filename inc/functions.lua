...
if cmd == "biouser" then
return SendMention(ChatID,UserID,MsgID,"➸ البايو\n\n "..biouser.."",37,USERCAR)
end
...
msg.textmsg = [[ •🌟 ¦ أهلًا بك في قائمه الاوامر لسورس FZRD
...
• اعدادات المجموعه (للتحكم بالبوت) 

 [للاستفسارات اضغط هنا](t.me/divfzrd) ]]
...
msg.KeyboardCmd = list_settings
msg.textmsg = "- اهلا بك في لستة الاوامر .\n- الان يمكنك التحكم بالقفل والفتح في البوت ."
msg.Editeinline = true
return SendMsgInline(msg)
end
...
download_file('https://raw.githubusercontent.com/aboodes7ab/LHB/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/aboodes7ab/LHB/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/aboodes7ab/LHB/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/aboodes7ab/LHB/main/inc/functions.lua','./inc/functions.lua')
